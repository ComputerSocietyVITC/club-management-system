      ...
      <>
        <section className="flex items-center min-h-screen">
          <button
            ...
            className="flex items-center mx-auto border transition duration-500 ease-in-out scale-50 hover:border-white hover:scale-75 border-white/[0.2] rounded-3xl bg-gradient-to-r from-black via-50% from-5% to-95% via-[#0414288f] to-black px-16 py-6 justify-around font-light text-white text-6xl"
          >
            Sign in with Google
          </button>
        </section>
